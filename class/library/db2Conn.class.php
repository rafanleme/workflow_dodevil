...
if ((isset($_REQUEST["db2form"]) AND ($_REQUEST["db2form"]=="yes")) OR (isset($_REQUEST["db2formmulti"]) AND ($_REQUEST["db2formmulti"]=="yes"))){	include("../include/config.php");
  ...
  class db2Conn {
    ...
    private $sql_host = ""; //10.106.26.1
    private $sql_database = ""; //FGE5006CDM
    private $sql_user = ""; //jmuniz
    private $sql_pass = ""; //jmuniz
    ...
    public function db2Open(){
      ...
      try {
        $this->db2Conn = new PDO("odbc:DRIVER=".$this->sql_type.";SYSTEM=".$this->sql_host.";DATABASE=".$this->sql_database.";PROTOCOL=TCPIP;UID=".$this->sql_user.";PWD=".$this->sql_pass.";",$this->sql_user,$this->sql_pass);
