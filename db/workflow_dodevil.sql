...
--
-- Servidor: localhost
-- Tempo de Geração: Mar 27, 2016 as 03:38 PM
...
(37, 3, 36, 'Janelas', 'Cadastro de Janelas de Coletas', 'cad_janelas/', 'cad_janelas/', 1, 0, 'sys'),
...
(36, 3, 0, 'Agendamento', 'Menu de Agendamento de Coletas', '#', '#', 1, 0, 'sys'),
...
(34, 3, 0, 'Integração', 'Integração de pedidos', '#', '#', 1, 0, 'sys'),
(38, 3, 36, 'Agendar', 'Tela principal de agendamento', 'cad_agendamentos/', 'cad_agendamentos/', 1, 0, 'sys');
