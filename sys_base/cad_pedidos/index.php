...
<table align=center width="100%">
	<tr>
		...
		<?php
			...
			{
				$_POST["frmData"] = date("Y-m-d");
			}
		?>
		<input type="text" size=10 maxlength=10 name="frmData" id="frmData" value="<? echo $_POST["frmData"]; ?>" readonly>
			<a href='#' onClick='cal.select(document.form1.frmData,"frmData","yyyy-MM-dd"); return false;' NAME='frmData' ID='frmData'>
			<img src='../../images/btn_calendar.png' border='0' align='middle'>
			</a>
		<input type="button" name="btn1" value="ok" id="input_btn_send" onClick="calGridPed();">
		</td>
		</td>  
	</tr>
</table>
