...
HM_GL_ImageDir = "/etrporju/hr_menu/";
HM_ScriptDir   = "/etrporju/hr_menu/";
...
if(HM_IsMenu) {
	...
	document.write("<SCR" + "IPT LANGUAGE='JavaScript1.2' SRC='" + HM_ScriptDir + "HM_Arrays.php' TYPE='text/javascript'><\/SCR" + "IPT>");
